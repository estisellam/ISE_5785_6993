...
class LightsTests {
   ...
   /** Produce a picture of a sphere lighted by a narrow spotlight -bonus */
   @Test
   ...
   void trianglesMultiLights() {
      ...
      scene2.lights.addAll(List.of(
              new DirectionalLight(new Color(180, 220, 255), new Vector(0, -1, -0.5)),//light blue

              new PointLight(new Color(180, 255, 200), new Point(-10, 30, 40))//green
                      .setKl(0.0001).setKq(0.00001),

              new SpotLight(new Color(200, 160, 255), new Point(50, 100, 200), new Vector(-2, -2, -3))
                      .setKl(0.0007).setKq(0.00004)
      ));

      camera2.setResolution(500, 500)
              .build()
              .renderImage()
              .writeToImage("trianglesMultiLights");
   }


   /** Produce a picture of two triangles lighted by a narrow spotlight -bonus */
   @Test
   ...
   void sphereMultiLights() {
      ...
      scene1.lights.addAll(List.of(
              new DirectionalLight(new Color(255, 230, 180), new Vector(-1, -1, -1)),//orange
              new PointLight(new Color(180, 220, 255), new Point(20, -20, 20))  //light blue
                      .setKl(0.001).setKq(0.00005),
              new SpotLight(new Color(255, 200, 220), new Point(-30, 30, 30), new Vector(1, -1, -1))  // pink
                      .setKl(0.0005).setKq(0.00005).setNarrowBeam(10)
      ));

      camera1.setResolution(500, 500)
              .build()
              .renderImage()
              .writeToImage("sphereMultiLights");
   }
